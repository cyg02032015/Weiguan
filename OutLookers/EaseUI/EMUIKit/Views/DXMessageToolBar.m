...
//    self.inputTextView.contentMode = UIViewContentModeCenter;
    ...
    _inputTextView.placeHolder = @"评论一下";
    _inputTextView.delegate = self;
    _inputTextView.backgroundColor = [UIColor colorWithRed:233/255.0 green:236/255.0 blue:239/255.0 alpha:1.0];
//    _inputTextView.layer.borderColor = [UIColor colorWithWhite:0.8f alpha:1.0f].CGColor;
//    _inputTextView.layer.borderWidth = 0.65f;
    _inputTextView.layer.cornerRadius = 36/2;
//    _inputTextView.textContainer.lineFragmentPadding = 0;
    _previousTextViewContentHeight = [self getTextViewContentH:_inputTextView];
    _inputTextView.textContainerInset = UIEdgeInsetsMake(7, 29, 0, 29);
