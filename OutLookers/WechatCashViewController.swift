//
//  WechatCashViewController.swift
//  OutLookers
//
...
class WechatCashViewController: YGBaseViewController {
...
extension WechatCashViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.delegate = self
        cell.setTextInCell("金额(元)", placeholder: "账户余额3000")
        return cell
    }
    ...
    override func tableView(tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        let view = UIView(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: kHeight(513)))
...
extension WechatCashViewController: NoArrowEditCellDelegate {
