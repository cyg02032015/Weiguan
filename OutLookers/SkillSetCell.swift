...
class SkillSetCell: UITableViewCell {
    ...
    func setupSubViews() {
        ...
        setCoverLabel.font = UIFont.customFontOfSize(16)
        ...
        addPictureLabel.font = UIFont.customFontOfSize(16)
        ...
        label.snp.makeConstraints { (make) in
            make.left.top.equalTo(label.superview!).offset(kScale(15))
            make.height.equalTo(kScale(16))
        }
        
        line1.snp.makeConstraints { (make) in
            make.top.equalTo(label.snp.bottom).offset(kScale(15))
        ...
        setCoverLabel.snp.makeConstraints { (make) in
            make.top.equalTo(line1.snp.bottom).offset(kScale(20))
            make.left.equalTo(label)
            make.height.equalTo(kScale(16))
        }
        
        photoButton.snp.makeConstraints { (make) in
            make.top.equalTo(setCoverLabel.snp.bottom).offset(kScale(15))
            make.left.equalTo(label)
            make.size.equalTo(kSize(70, height: 70))
        }
        
        line2.snp.makeConstraints { (make) in
            make.height.equalTo(line1)
            make.left.equalTo(label)
            make.top.equalTo(photoButton.snp.bottom).offset(kScale(20))
            make.right.equalTo(line1.superview!)
        }
        ...
        addVideoLabel.snp.makeConstraints { (make) in
            make.height.equalTo(kScale(16))
            make.left.equalTo(label)
            make.top.equalTo(line2.snp.bottom).offset(kScale(20))
        }
        
        videoButton.snp.makeConstraints { (make) in
            make.left.equalTo(label)
            make.top.equalTo(addVideoLabel.snp.bottom).offset(kScale(15))
            make.size.equalTo(kSize(70, height: 70))
        }
        
        line3.snp.makeConstraints { (make) in
            make.left.equalTo(label)
            make.top.equalTo(videoButton.snp.bottom).offset(kScale(20))
            make.height.equalTo(line1)
            make.right.equalTo(line1.superview!)
        }
        
        addPictureLabel.snp.makeConstraints { (make) in
            make.top.equalTo(line3.snp.bottom).offset(kScale(20))
            make.height.equalTo(kScale(16))
            make.left.equalTo(label)
        }
        
        collectionView.snp.makeConstraints { (make) in
            make.top.equalTo(addPictureLabel.snp.bottom).offset(kScale(15))
